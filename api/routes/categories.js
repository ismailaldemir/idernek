    ...
    try {
        const response = await createEntity(Categories, req.body, req.file, req.user);
        res.json(response);
    } catch (error) {
        res.status(error.code || 500).json(Response.errorResponse(error));
    }
    ...
    try {
        const response = await updateEntity(Categories, req.body._id, req.body, req.file);
        res.json(response);
    } catch (error) {
        res.status(error.code || 500).json(Response.errorResponse(error));
    }
    ...
    try {
        ...
        throw new CustomError(Enum.HTTP_CODES.BAD_REQUEST, "IDs must be provided.");
        }

        const response = await softDeleteEntities(Categories, req.body.ids);
        res.json(response);
    } catch (error) {
        res.status(error.code || 500).json(Response.errorResponse(error));
    }
    ...
    try {
        ...
        const response = await deleteEntities(Categories, req.body.ids);
        res.json(response);
    } catch (error) {
        res.status(error.code || 500).json(Response.errorResponse(error));
    }
    ...
    try {
        ...
        const response = await restoreEntities(Categories, req.body.ids);
        res.json(response);
    } catch (error) {
        res.status(error.code || 500).json(Response.errorResponse(error));
    }
